// api/admin/threshold-gift-toggle.js — Toggle SKU подарков по порогу 2500₽
...
const FILE = path.join(DATA_DIR, 'threshold-gifts.json');
...
const handler = async (req, res) => {
  ...
  try {
    ...
    console.error('threshold-gift-toggle error:', error.message);
