...
const TARIFFS = [
  ...
  },
  {
    ...
    label: '690 ₽ / мес',
    title: 'Скидки + Роллы',
    perks: ['−30% на все роллы', '−20% на все сеты', 'Бесплатный ролл каждые 15 дней'],
    accent: '#3CC8A1',
    featured: true,
  },
  {
    ...
    label: '1390 ₽ / мес',
    title: 'Скидки + Сеты',
    perks: ['−30% на все роллы', '−20% на все сеты', 'Бесплатный сет каждые 30 дней', 'Бесплатный кофе к заказу'],
    accent: '#f5923a',
  },
];
