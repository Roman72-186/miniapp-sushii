...
const valuePoints = [
  ...
  },
  {
    ...
    text: 'В старших тарифах подарочные роллы и сеты открываются по календарю, чтобы подписка давала больше, чем скидку.',
  },
  {
    stat: 'SHC',
...
const tariffs = [
  ...
  },
  {
    ...
    perks: ['подарочный ролл каждые 15 дней', 'подарочный сет каждые 30 дней', 'VIP-клуб и кофе к заказу'],
  },
];
...
const faq = [
  ...
  },
  {
    ...
    answer:
      'Это дополнительная выгода поверх скидок. В тарифе 690 ₽ доступен подарочный ролл каждые 15 дней, а в тарифе 1 390 ₽ добавляется подарочный сет каждые 30 дней.',
  },
  {
