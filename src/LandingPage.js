...
const faq = [
  ...
  },
  {
    ...
    answer:
      'В меню подписки есть подарки за сумму заказа: при чеке выше 2 000 ₽ можно применить промокод 102030 и получить ролл в подарок, а при чеке выше 2 500 ₽ ролл добавляется автоматически.',
  },
  {
        ...
        <div className="landing-section__inner">
          ...
          <div className="landing-order-gifts landing-reveal" aria-label="Подарки за сумму заказа">
            <div className="landing-order-gifts__copy">
              ...
              <p>Если заказ получается крупнее, подписчик может получить дополнительный ролл: по промокоду от 2 000 ₽ или автоматически от 2 500 ₽.</p>
            </div>
