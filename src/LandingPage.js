...
const seo = {
  ...
  description:
    'Подписка Суши-Хаус 39 помогает экономить на каждом заказе: до 30% на роллы, до 20% на сеты, подарочные периоды, подарки за чек, SHC-баллы и меню подписки онлайн в Калининграде.',
  canonical: SITE_URL,
...
const defaultHeroLead = (
  <>
    ...
    часть бюджета: скидки, подарки за тариф и чек, SHC-баллы и отдельное меню подписчика.
  </>
);
...
const orderGiftPerks = [
  {
    amount: 'промо',
    badge: 'по промокоду',
    text: 'Введите актуальный промокод в корзине и получите выбранный подарок, когда сумма заказа достигает настроенного порога.',
  },
  {
    amount: 'порог',
    badge: 'автоматически',
    text: 'Когда чек достигает одного из активных порогов, подарок подтягивается в корзину автоматически - без промокода и лишних действий.',
  },
];
...
const faq = [
  ...
  {
    question: 'Какие еще подарки есть при заказе?',
    answer:
      'В меню подписки есть подарки за сумму заказа: часть акций работает по промокоду, а часть добавляет подарок автоматически при достижении активного порога чека.',
  },
  {
    ...
    <main className="landing-page">
      ...
      <section className="landing-section landing-section--intro landing-reveal" id="benefits">
        <div className="landing-section__inner">
          ...
          <div className="landing-order-gifts landing-reveal" aria-label="Подарки за сумму заказа">
            <div className="landing-order-gifts__copy">
              <p className="landing-section__eyebrow">Подарки за чек</p>
              <h3>Скидка работает на меню, а подарки добирают выгоду сверху</h3>
              <p>Если заказ получается крупнее, вы получаете дополнительный подарок: по активному промокоду или автоматически при достижении порога.</p>
            </div>
            <div className="landing-order-gifts__cards">
              {orderGiftPerks.map((gift) => (
