// create-user-from-watbot.js — Создание пользователя из данных Watbot
...
if (user) {
  ...
  db.prepare(`
    ...
    ) VALUES (?, ?, ?, ?, 'активно', ?, ?, ?, 0, 0, datetime('now'), datetime('now'))
  `).run(telegramId, name, phone, tariff, subscriptionStart, subscriptionEnd, watbotContactId);
}
